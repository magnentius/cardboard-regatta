...
## ⏱️ Turn Structure
1. **Phase 1: Wind & Forecast Phase**
   - The wind forecast last round **arrives**: move the Wind Marker to it, apply any Puff.
   ...
   - Roll **2d6** for *next* round's wind and place the Forecast Marker.
...
*Base Wind is North (0°). Max Momentum increases by 1 if a **Puff** is active.*
...
| **Bear Off** | Any (except Run) | None | Turn 60° away from wind. *(At Momentum 0: pivot in place without moving forward)*. |
